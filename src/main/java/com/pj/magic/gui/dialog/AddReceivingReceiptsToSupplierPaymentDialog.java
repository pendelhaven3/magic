...
@Component
public class AddReceivingReceiptsToSupplierPaymentDialog extends MagicDialog {
	...
	public AddReceivingReceiptsToSupplierPaymentDialog() {
		setSize(500, 250);
		setLocationRelativeTo(null);
		setTitle("Add Receiving Receipts to Supplier Payment");
	}
