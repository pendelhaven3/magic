...
@Component
public class JchsRaffleMenuPanel extends MenuPanel {

	private static final String TICKETS = "JCHS Raffle Tickets";
	private static final String TICKET_CLAIMS = "JCHS Raffle Ticket Claims";
	...
	private void selectMenuItem() {
		...
		case TICKETS:
			getMagicFrame().switchToJchsRaffleTicketsListPanel();
			break;
		case TICKET_CLAIMS:
