...
import com.pj.magic.excel.AlfonsoRaffleTicketsExcelGenerator;
...
@Component
public class AlfonsoRaffleTicketsListPanel extends StandardMagicPanel {
	...
	public void updateDisplay() {
		...
		List<PromoRaffleTicket> tickets = promoService.getAllAlfonsoRaffleTickets();
	...
	private void generateExcel() {
		...
		excelFileChooser.setSelectedFile(new File("Alfonso Raffle 2023 Tickets.xlsx"));
		...
		try (
			Workbook workbook = new AlfonsoRaffleTicketsExcelGenerator().generate(tickets);
