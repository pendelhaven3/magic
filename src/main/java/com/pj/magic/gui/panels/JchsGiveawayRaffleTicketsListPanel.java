...
import com.pj.magic.excel.JchsGiveawayRaffleTicketsExcelGenerator;
...
@Component
public class JchsGiveawayRaffleTicketsListPanel extends StandardMagicPanel {
	...
	public void updateDisplay() {
		...
		List<PromoRaffleTicket> tickets = promoService.getAllJchsGiveawayRaffleTickets();
	...
	private void generateExcel() {
		...
		excelFileChooser.setSelectedFile(new File("JCHS Giveaway Raffle 2024 Tickets.xlsx"));
		...
		try (
			Workbook workbook = new JchsGiveawayRaffleTicketsExcelGenerator().generate(tickets);
