...
@Component
public class JchsCellphoneRaffleTicketClaimsListPanel extends StandardMagicPanel {
	...
	public void updateDisplay() {
		...
		tableModel.setItems(promoService.getAllJchsCellphoneRaffleTicketClaims());
	...
	protected void selectTicketClaim() {
		...
		getMagicFrame().switchToJchsCellphoneRaffleTicketClaimPanel(claim);
	}

	private void switchToNewTicketClaimPanel() {
		getMagicFrame().switchToJchsCellphoneRaffleTicketClaimPanel(new PromoRaffleTicketClaim());
	}
	...
	private void searchClaims() {
		...
		if (customer != null) {
			tableModel.setItems(promoService.findAllJchsCellphoneRaffleTicketClaimsByCustomer(customer));
		} else {
			tableModel.setItems(promoService.getAllJchsCellphoneRaffleTicketClaims());
		}
