...
//		printPreviewDialog.setVisible(true);
	...
	private UnpaidReceivingReceiptsReport createUnpaidSalesInvoicesReport() {
		UnpaidReceivingReceiptsReport report = new UnpaidReceivingReceiptsReport();
		report.setReceivingReceipts(receivingReceiptService.findAllUnpaidReceivingReceipts());
		return report;
	}
