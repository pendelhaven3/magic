...
public class SalesInvoicePanel extends StandardMagicPanel {
	...
	protected void doOnBack() {
		getMagicFrame().back(MagicFrame.SALES_INVOICES_LIST_PANEL);
	}
	...
	protected void addToolBarButtons(MagicToolBar toolBar) {
		...
		JButton printBirFormCharge2Button = 
				new MagicToolBarButton("print_bir_form_charge2", "Print BIR form (Charge) 2");
		printBirFormCharge2Button.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				printService.printBirChargeForm2(salesInvoice);
			}
		});
		toolBar.add(printBirFormCharge2Button);
		
		JButton printBirFormCharge3Button = 
				new MagicToolBarButton("print_bir_form_charge3", "Print BIR form (Charge) 3");
		printBirFormCharge3Button.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				printService.printBirChargeForm3(salesInvoice);
			}
		});
