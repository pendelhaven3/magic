...
@Getter
@Setter
public class BadStockInventoryCheckItemRowItem {

	private BadStockInventoryCheckItem item;
	private Product product;
	private String unit;
	private Integer quantity;
	private Integer quantityChange;

	public BadStockInventoryCheckItemRowItem(BadStockInventoryCheckItem item) {
		this.item = item;
		reset();
	}
	...
	public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BadStockInventoryCheckItemRowItem)) {
            return false;
        }
        BadStockInventoryCheckItemRowItem other = (BadStockInventoryCheckItemRowItem)obj;		
