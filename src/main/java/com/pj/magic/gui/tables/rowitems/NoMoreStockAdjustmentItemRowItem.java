 ...
 */
public class NoMoreStockAdjustmentItemRowItem {
	...
	public NoMoreStockAdjustmentItemRowItem(NoMoreStockAdjustmentItem item) {
		this.item = item;
		reset();
	}
	
	public NoMoreStockAdjustmentItem getItem() {
		return item;
	}

	public void setItem(NoMoreStockAdjustmentItem item) {
		this.item = item;
	}
	...
	public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NoMoreStockAdjustmentItemRowItem)) {
            return false;
        }
        NoMoreStockAdjustmentItemRowItem other = (NoMoreStockAdjustmentItemRowItem)obj;		
