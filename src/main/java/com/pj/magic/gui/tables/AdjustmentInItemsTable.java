...
@Component
public class AdjustmentInItemsTable extends ItemsTable {
	...
	private boolean hasDuplicate(AdjustmentInItemRowItem rowItem) {
		AdjustmentInItem checkItem = new AdjustmentInItem();
	...
	protected void registerKeyBindings() {
		...
		final AdjustmentInItemsTable table = this;
		...
		actionMap.put(TAB_ACTION_NAME, new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				AdjustmentInItemRowItem rowItem = table.getCurrentlySelectedRowItem();
...
//				}
	...
	public boolean validateQuantity(AdjustmentInItem item) {
	...
	public boolean validateQuantity(AdjustmentInItemRowItem rowItem) {
