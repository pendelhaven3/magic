...
import com.pj.magic.gui.tables.models.PromoType4RulePromoProductsTableModel;
...
@Component
public class PromoType4RulePromoProductsTable extends MagicTable {

	public static final int CODE_COLUMN_INDEX = 0;
	public static final int DESCRIPTION_COLUMN_INDEX = 1;
	
	@Autowired private PromoType4RulePromoProductsTableModel tableModel;
	@Autowired private ProductService productService;
	@Autowired private SelectProductDialog selectProductDialog;
	
	private PromoType4Rule rule;
	
	@Autowired
	public PromoType4RulePromoProductsTable(PromoType4RulePromoProductsTableModel tableModel) {
		super(tableModel);
		initializeColumns();
	...
	public PromoType4RulePromoProduct getCurrentlySelectedPromoProduct() {
	...
	private void doDeleteCurrentlySelectedRule() {
		...
		PromoType4RulePromoProduct promoProduct = getCurrentlySelectedPromoProduct();
