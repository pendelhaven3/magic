...
import com.pj.magic.gui.tables.models.NoMoreStockAdjustmentItemsTableModel;
...
@Component
public class NoMoreStockAdjustmentItemsTable extends MagicTable {
	...
	@Autowired
	public NoMoreStockAdjustmentItemsTable(NoMoreStockAdjustmentItemsTableModel tableModel) {
		super(tableModel);
	}
	...
	public NoMoreStockAdjustmentItemRowItem getCurrentlySelectedRowItem() {
