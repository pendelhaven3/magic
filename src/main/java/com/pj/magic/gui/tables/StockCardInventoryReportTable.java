...
public class StockCardInventoryReportTable extends MagicListTable {
	...
	public static final int ADD_QUANTITY_COLUMN_INDEX = 4;
	public static final int LESS_QUANTITY_COLUMN_INDEX = 5;
	public static final int CURRENT_COST_COLUMN_INDEX = 6;
	public static final int AMOUNT_COLUMN_INDEX = 7;
	public static final int REFERENCE_NUMBER_COLUMN_INDEX = 8;
