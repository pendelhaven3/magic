...
@Component
public class PromoType6RulePromoProductsTable extends MagicTable {

    private static final long serialVersionUID = 7242165648187076969L;
	...
	@Autowired
	public PromoType6RulePromoProductsTable(PromoType6RulePromoProductsTableModel tableModel) {
		super(tableModel);
		initializeColumns();
	...
	public PromoType6RulePromoProduct getCurrentlySelectedPromoProduct() {
		return tableModel.getPromoProduct(getSelectedRow());
	}
	
	private class ProductCodeCellEditor extends MagicCellEditor {

        private static final long serialVersionUID = 5597237236621275430L;
