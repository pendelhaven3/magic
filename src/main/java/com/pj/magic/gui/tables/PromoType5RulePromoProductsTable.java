...
import com.pj.magic.gui.tables.models.PromoType5RulePromoProductsTableModel;
...
@Component
public class PromoType5RulePromoProductsTable extends MagicTable {

	public static final int CODE_COLUMN_INDEX = 0;
	public static final int DESCRIPTION_COLUMN_INDEX = 1;
	
	@Autowired private PromoType5RulePromoProductsTableModel tableModel;
	...
	@Autowired
	public PromoType5RulePromoProductsTable(PromoType5RulePromoProductsTableModel tableModel) {
		super(tableModel);
		initializeColumns();
	...
	public PromoType5RulePromoProduct getCurrentlySelectedPromoProduct() {
	...
	private void doDeleteCurrentlySelectedRule() {
		...
		PromoType5RulePromoProduct promoProduct = getCurrentlySelectedPromoProduct();
