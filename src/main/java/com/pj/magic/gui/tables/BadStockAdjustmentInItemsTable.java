...
import com.pj.magic.gui.tables.models.BadStockAdjustmentInItemsTableModel;
...
@Component
public class BadStockAdjustmentInItemsTable extends MagicTable {
	...
	@Autowired
	private BadStockAdjustmentInItemsTableModel tableModel;
	...
	@Autowired
	public BadStockAdjustmentInItemsTable(BadStockAdjustmentInItemsTableModel tableModel) {
		super(tableModel);
		initializeColumns();
	...
	public void switchToEditMode() {
		...
		addMode = false;
		List<BadStockAdjustmentInItem> items = adjustmentIn.getItems();
//		items.addAll(tableModel.getItems());
	...
	public void doDeleteCurrentlySelectedItem() {
		...
		BadStockAdjustmentInItem item = getCurrentlySelectedRowItem().getItem();
	...
	public BadStockAdjustmentInItemRowItem getCurrentlySelectedRowItem() {
		return tableModel.getRowItem(getSelectedRow());
	}
	
	private boolean hasDuplicate(String unit, BadStockAdjustmentInItemRowItem rowItem) {
		for (BadStockAdjustmentInItem item : adjustmentIn.getItems()) {
	...
	private BadStockAdjustmentInItem createBlankItem() {
	...
	public void highlightColumn(BadStockAdjustmentInItem item, int column) {
	...
	private class UnitCellEditor extends MagicCellEditor {
		...
		public boolean stopCellEditing() {
			...
			if (StringUtils.isEmpty(unit)) {
				...
				BadStockAdjustmentInItemRowItem rowItem = getCurrentlySelectedRowItem();
